...
async function addMissingUsers() {
  ...
  const usersToAdd = [
    { name: 'Priya Sharma',  email: 'priya@royalpalace.com',  userRole: 'RECEPTIONIST' as const },
    { name: 'Sunita Devi',   email: 'sunita@royalpalace.com', userRole: 'HOUSEKEEPING' as const },
    { name: 'Rahul Mehta',   email: 'rahul@royalpalace.com',  userRole: 'ACCOUNTANT'   as const },
  ];
