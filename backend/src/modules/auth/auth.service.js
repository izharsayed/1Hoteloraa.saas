"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }var _bcryptjs = require('bcryptjs'); var _bcryptjs2 = _interopRequireDefault(_bcryptjs);
...
const generateToken = (id, tenantId, email, userRole, roleId) => {
  return _jsonwebtoken2.default.sign({ id, tenantId, email, userRole, roleId }, _env2.default.jwt.secret, { expiresIn: _env2.default.jwt.expiresIn } );
};
